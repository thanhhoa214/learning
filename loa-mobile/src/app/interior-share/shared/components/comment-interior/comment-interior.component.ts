...
import { InteriorShareService } from '@loa-mobile/interior-share/interior-share.service';
...
import { InteriorShareStateModel } from '@loa-mobile/interior-share/store';
...
@Component({
  ...
  templateUrl: './comment-interior.component.html',
  styleUrls: ['./comment-interior.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CommentComponent extends SubSinkable implements OnChanges, OnDestroy {
  @Input() hide = false;
  @Input() id: InteriorShareStateModel['selectedNode']['id'];
  @Input() parentElement: IonContent;
  @Input() questionAnswer: InteriorShareStateModel['selectedNode']['comments'];
  ...
  constructor(
    private _detailService: InteriorShareService,
