...
@Component({
  selector: 'loa-mobile-comment-interior-listing',
  templateUrl: './comment-interior-listing.component.html',
  styleUrls: ['./comment-interior-listing.component.scss'],
})
export class CommentInteriorListingComponent implements OnInit {
  @Input() id: any;
